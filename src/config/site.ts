  ...
  tec: {
    ...
    operators: {
      ...
      details: [
        ...
        'Use the run record to propose a prompt or skill update. Compare the new version with the old one on held-out tasks, measure costs and regressions, and keep a way to undo the change.',
      ],
      within: 'WITHIN AN EPISODE',
      across: 'ACROSS EPISODES',
      evidence: 'Trajectory + feedback',
      gateLabel: 'Evidence and version checks are complete',
